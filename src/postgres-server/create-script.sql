...
ALTER TABLE doctor_patient ADD CONSTRAINT fk_doctor_patient_doctor FOREIGN KEY (doctor_id) REFERENCES doctor (id) ON DELETE CASCADE;
ALTER TABLE doctor_patient ADD CONSTRAINT fk_doctor_patient_patient FOREIGN KEY (patient_id) REFERENCES patient (id) ON DELETE CASCADE;
